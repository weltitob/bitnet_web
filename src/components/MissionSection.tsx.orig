      ...
      <div className="mission-container">
        ...
        <div className="mission-content">
          ...
          <div className="mission-body">
            <p style={{ color: '#aaa', fontSize: '1.2rem', margin: '0 auto 4rem', maxWidth: '800px', textAlign: 'center' }}>Making Bitcoin accessible to all by reimagining how you send, save, and use money in the digital age.</p>
            ...
            <div className="mission-values">
              ...
              <div className="mission-value">
                ...
                <div className="value-content">
                  <h3>Innovation</h3>
                  <p>Cutting-edge Bitcoin technology enabling previously impossible experiences.</p>
                </div>
              </div>
              ...
              <div className="mission-value">
                ...
                <div className="value-content">
                  <h3>Decentralized</h3>
                  <p>True to Bitcoin's spirit, with no central control or single point of failure.</p>
                </div>
              </div>
              ...
              <div className="mission-value">
                ...
                <div className="value-content">
                  <h3>User-Friendly</h3>
                  <p>Complex Bitcoin technology made simple with an intuitive interface.</p>
                </div>
              </div>
            </div>
          </div>
